...
public class St2EliteController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        ChangeState(new St2IdleState()); // 초기 상태: 대기
    }
    ...
    public void ChangeState(St2EliteState newState)
    {
        currentState?.OnExit();
