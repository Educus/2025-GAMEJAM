...
public class St4EliteController : MonoBehaviour
{
    public Transform player;               // 플레이어 위치
    public GameObject slashPrefab;         // 참격 프리팹
    ...
    private St4EliteState currentState;    // 현재 상태
    ...
    private void Start()
    {
        ...
        ChangeState(new St4IdleState()); // 초기 상태: 대기
    }
    ...
    public void ChangeState(St4EliteState newState)
    {
        currentState?.OnExit();
